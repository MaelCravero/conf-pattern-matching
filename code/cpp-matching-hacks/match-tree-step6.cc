...
struct Mem
    : public Tree<T, None>
    , std::enable_shared_from_this<Mem<T>>
{
    ...
    virtual vTree<T, None> variant() override
    {
        sMem<T> res(this->shared_from_this());
        return res;
    }
...
struct Move
    : public Tree<D, S>
    , std::enable_shared_from_this<Move<D, S>>
{
    ...
    {
        sMove<D, S> res(this->shared_from_this());
        return res;
    }
